...
const toFullUrl = (url) => {
  ...
  // SAFEGUARD: Ensure we have a base URL.
    ...
    <UserLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        <div className="relative w-full mb-12">
          ...
          {/* Floating Card Container - Fixed Layout */}
          <div className="relative -mt-16 px-2 sm:px-6 z-10 flex justify-center">
             
             {/* Main Card with LARGE GAP (gap-12) to prevent sticking */}
             <div className="w-full max-w-6xl bg-white p-6 md:p-8 rounded-2xl shadow-2xl border border-gray-100 flex flex-col md:flex-row gap-8 md:gap-12 items-start">
              ...
              {/* Logo Section - Popped Out Negative Margin */}
              ...
              <div className="flex-1 min-w-0 w-full text-center md:text-left pt-2 md:pt-1">
                ...
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-x-8 gap-y-3 mb-6">
                  {clinic.phone && (
                    ...
                    >
                      <span className="p-1.5 rounded-full bg-slate-100 text-slate-500 group-hover:bg-blue-100 group-hover:text-blue-600 transition-colors">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={styleSecondaryText}>
                  ...
                  <div className="flex items-center gap-2 text-base text-slate-600">
                    <span className="p-1.5 rounded-full bg-slate-100 text-slate-500">
                      <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={styleSecondaryText}>
                ...
                {/* Description - Separated with Border */}
                {description && (
                ...
                {clinic.timings && (
                  <div className="flex justify-center md:justify-start mt-5">
                    <span
                      className="inline-flex items-center rounded-lg px-4 py-1.5 text-sm font-medium text-white shadow-md"
