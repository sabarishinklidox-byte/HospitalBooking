...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // matches your constants: FORGOT_PASSWORD = '/public/forgot-password'
      const res = await api.post("/public/forgot-password", {
      ...
      // optional: move user to reset page info screen or back to login
      // navigate("/login");
    } catch (err) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
        ...
        <p className="text-sm text-gray-500 text-center mb-6">
          Enter your email. If the account exists, a reset link will be sent.
        </p>
