          ...
          <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 rounded-lg font-bold text-white bg-[#003366] hover:bg-[#002244] shadow-lg hover:shadow-xl transition-all disabled:opacity-70 disabled:cursor-not-allowed"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <Link
                ...
                className="py-3 rounded-lg border-2 border-blue-200 bg-blue-50 text-blue-700 font-semibold hover:bg-blue-100 transition-all text-center"
              >
                Admin
              </Link>
              ...
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="py-3 rounded-lg border-2 border-emerald-200 bg-emerald-50 text-emerald-700 font-semibold hover:bg-emerald-100 transition-all text-center"
              >
                Doctor
              </Link>
            </div>
