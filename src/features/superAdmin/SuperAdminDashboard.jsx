// src/features/superAdmin/SuperAdminDashboard.jsx
...
export default function SuperAdminDashboard() {
  ...
  const fetchStats = async () => {
    try {
      ...
      const totalDoctors = clinicsList.reduce(
        (sum, clinic) =>
          sum + Number(clinic.doctorCount || clinic.doctors?.length || 0),
        0
      );
  ...
  const handleClinicFileUpload = async (e, field) => {
    ...
    try {
      ...
      // POST /api/super-admin/clinics/upload
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all relative overflow-hidden">
            ...
            <div className="flex justify-between items-start relative z-10">
              <div>
                ...
                <h2 className="text-4xl font-black text-[#003366]">
                  {stats.clinics}
                </h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    type="file"
                    accept="image/*"
                    onChange={(e) => handleClinicFileUpload(e, 'logo')}
                  />
                  {uploading.logo && (
                ...
                <div>
                  ...
                  <input
                    type="file"
                    accept="image/*"
                    onChange={(e) => handleClinicFileUpload(e, 'banner')}
                  />
                  {uploading.banner && (
                    <p className="mt-1 text-xs text-gray-400">
                      Uploading banner...
