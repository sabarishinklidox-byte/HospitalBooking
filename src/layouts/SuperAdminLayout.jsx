  ...
  <NavLink to="/super-admin/revenue" onClick={closeSidebar} className={navLinkClasses}>
  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  <NavLink
  to="/super-admin/gateway"
  onClick={closeSidebar}
  className={navLinkClasses}
>
  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" 
      d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9a5.002 5.002 0 006.001 0M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0m-9 0a5.002 5.002 0 006.001 0M21 7a9 9 0 11-18 0 9 9 0 0118 0z"/>
  </svg>
  Payment Gateway
</NavLink>
